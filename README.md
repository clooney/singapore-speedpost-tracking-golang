# Singapore Speedpost Tracking API For Golang
Singapore Speedpost Tracking API and webhook make it easy to integrate Singapore Speedpost Tracking function into your own project. Support APIs Client Libraries for golang

### API key

In order to use this API, you need to generate a Singapore Speedpost Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use Singapore Speedpost Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [Singapore Speedpost Tracking API](https://www.trackingmore.com/singapore-speedpost-tracking.html)  to:

   *   Get Singapore Speedpost realtime tracking info of muti-carriers in one integration
   *   Provide Singapore Speedpost shipment tracking experience like Amazon
   *   Push Singapore Speedpost notifications of package update with webhook
   *   Verify Singapore Speedpost delivery exception before it is too late
